...
#
get_filename_component(filename "C:/Users/Wo.Lin/source/repos/zSpace_3DPSlicer/zspace_download-prefix/src/zspace_external_win64.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/Wo.Lin/source/repos/zSpace_3DPSlicer/external/zspace" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-zspace_download${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-zspace_download${i}")
