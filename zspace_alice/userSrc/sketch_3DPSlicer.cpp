...
string cablesDir = "data/IN/cableGraphs";
string blockDir = "data/IN/blockJson";
string expBlockDir = "data/Out/Sliced";
int blockID = 0;
...
void setup()
{
	...
	S.sliders[1].attachToVariable(&_slider_blockID, 0, 1);
